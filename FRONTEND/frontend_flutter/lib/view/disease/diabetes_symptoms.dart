...
class DiabetesSymptomsView extends StatefulWidget {
  ...
  const DiabetesSymptomsView({Key? key, this.userData}) : super(key: key);

  @override
  State<DiabetesSymptomsView> createState() => _DiabetesSymptomsViewState();
}
...
class _DiabetesSymptomsViewState extends State<DiabetesSymptomsView> {
  String gender = 'Male';
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildLabel("Blood Glucose Levels (random):",
                  subtitle: "Normal range: 70-99 mg/dL"),
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      try {
                        ...
                        final requestData = {
                          ...
                          'hypertension': hypertension.toLowerCase(),
